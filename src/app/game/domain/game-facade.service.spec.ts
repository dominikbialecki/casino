...
describe('GameFacadeService', () => {
  ...
  it('should provide refreshable games', fakeAsync(() => {
    ...
    const game4 = gameDtoMock({ id: '5', categories: [GameCategory.NEW] });
    const game5 = gameDtoMock({ id: '4', categories: [GameCategory.TOP] });
    ...
    service.gamesByCategory(GameCategory.NEW)
      .pipe(take(2))
